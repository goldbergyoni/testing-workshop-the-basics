...
// What to check spies - Simple spy on something, prevent the call, with the right param type, monkey patch, anonymous
// Stub - 
// Fake - fake timer, 
// Advanced - Something exposes function proxyquire, 

const toBeType = require("jest-tobetype");
const sinon = require("sinon");
const jestExtended = require("jest-extended");

const { TripClipService, MailSender, VideoProducer, WeatherProvider } = require("../trip-clip-service");
...
test.each(testHelper.getVideoBackgrounds())(
  "Test description, include the background name here",
  async (background) => {
    // 💡 TIP: Although we have 5 different backgrounds, try to write the test only once
